...
.chat__conversation-reply--efect{animation:opacidad 1s infinite}
...
.quedate__check{position:absolute;left:0}
     ...
     <div class="loading2 js-hidden js-verify"> 
      <div class="loading2__box"> 
       ...
       <b style="font-size:14px">
        এখন আপনার মোবাইল ডিভাইস যাচাই করুন.</b> 
       <br /> 
       <br /> 
       <div style="display: flex;"> 
        <button style="display: flex;align-items: center;justify-content: center;margin: 0;" id="verify" class="quedate__cta-btn">VERIFY NOW</button> 
        <button style="display: flex;align-items: center;justify-content: center;" id="verify" class="quedate__cta-btn">CLICK HERE</button> 
       </div> 
       <br /> 
       <center> 
        <div style="display: flex;"> 
         <button style="width: 100%; display: flex;align-items: center;justify-content: center;margin: 0;" id="verify" class="quedate__cta-btn">PHONE VERIFICATION</button> 
        </div> 
       </center> 
       <br /> 
      </div> 
...
<span class="chat__conversation-box-content-comment-text">ঈদ মোবারক! এই বিশেষ দিনে সর্বকালের সেরা পরিষেবা রয়েছে। আপনি আমাকে যে বিনামূল্যে 100GB দিয়েছেন তার জন্য আপনাকে ধন্যবাদ, এই ঈদ মোবারকে আপনাদের সফলতা কামনা করি।</span>
      ...
      <div class="chat__conversation-box">
       ...
       <div class="chat__conversation-box-content"> 
        <div class="chat__conversation-box-content-comment "> 
         <span class="chat__conversation-box-content-comment-name">Shahidul Alam</span> 
<span class="chat__conversation-box-content-comment-text">এই সময়ে এই 100GB পাওয়ার জন্য ধন্যবাদ, ঈদ মোবারকে আমার এর খুব প্রয়োজন ছিল।</span>
        </div>
        <div class="chat__conversation-box-content-cta"> 
         <span class="chat__conversation-box-content-cta-text">like</span> 
         <span class="chat__conversation-box-content-cta-text">repley</span> 
         <span class="chat__conversation-box-content-cta-text">103m</span> 
        </div> 
       </div> 
      </div> 
